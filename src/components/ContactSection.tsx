...
const ContactSection: React.FC = () => {
  ...
  return (
    <section
      id="contato"
      className="py-24 md:py-32 bg-transparent border-t border-gray-100"
    >
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-500 max-w-2xl leading-relaxed">
            {t("contact.subtitle") ||
              "Tem um projeto em mente ou quer apenas bater um papo? Sinta-se à vontade para me contatar."}
          </p>
        </motion.div>
