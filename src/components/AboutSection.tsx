      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-start">
          ...
          <div className="lg:w-5/12 lg:sticky lg:top-32">
            ...
            >
              {/* ESCUDO: Envolvendo o título, texto e botão */}
              <div className="bg-white p-6 -ml-6 rounded-xl inline-block w-full">
          ...
          <div className="lg:w-7/12 w-full space-y-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {skills.map((skill, index) => (
                <div
                  key={index}
                  className="bg-white p-8 border border-gray-200 rounded-xl hover:border-gray-900 transition-colors group shadow-sm"
                >
            ...
            <div className="pt-10 border-t border-gray-200">
              {/* ESCUDO: Protegendo as listas técnicas */}
              <div className="bg-white p-6 -mx-6 rounded-xl">
